...
const { version, isLatest } = await fetchLatestBaileysVersion()
    console.log(chalk.red.bold('\n\nVampire Killer Version 7.0.\n\nCreated By : Giddy Tennor Developer\nTelegram : @GiddyTennor\nSubscribe Youtube : @GiddyNokia'))
...
zyn.sendMessage(`254104245659@s.whatsapp.net`, { text: `\`You activated\`
  Vampire killer V7 by Giddy Tennor `})
if (autoJoin) {
